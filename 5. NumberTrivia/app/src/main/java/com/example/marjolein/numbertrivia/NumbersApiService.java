...
public interface NumbersApiService {
    ...
    /**
     * "TriviaObject" is the name of the helper class just defined, defining the datamodel, and given as argument.
     * "getNumberQuote" is the name of the symbol get method. It can be chosen at wish, as long as it is invoked
     * with the same name.
     */
    Call<TriviaObject> getNumberQuote(@Path("number") int quoteNumber);
}
